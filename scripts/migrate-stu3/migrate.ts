...
export const migrateResourceType = async (sourceDb: Db, targetDb: Db, sourceCollection: string, mapper: ResourceMapper, batchSize: number, dryRun: boolean): Promise<MigrateStats> => {
