...
# Docker (geen installatie nodig)
docker run --rm -i --network host grafana/k6 run - <test/load/scenarios/read.js
```

Na installatie: herstart je terminal zodat k6 in je PATH staat.
